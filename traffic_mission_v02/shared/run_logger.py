...
CSV_FIELDS = [
    ...
    "stop_line_detected", "lane_error", "raw_steer", "final_steer",
    "final_speed", "steering_pot", "traffic_signal", "car_detected", "car_label",
    "car_confidence", "car_bbox", "car_area_ratio", "car_result_age_s",
    "car_model_fault", "ultrasonic_json", "ultrasonic_age_json",
