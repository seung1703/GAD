...
from car_detector import AsyncCarDetector, CarDetection
...
class CarRoiTests(unittest.TestCase):
    def test_disabling_car_detector_clears_pending_and_latest_results(self):
        ...
        self.assertFalse(detector.latest().detected)
